...
def parse_args():
    ...
    parser.add_argument('--use_contrast', '-con', action='store_true',
                        help='use contrastive learning for training and evaluation')
    parser.add_argument('--use_msa', '-msa', action='store_true',
                        help='use retrieved-enhanced strategy for final score calculating')
    parser.add_argument('--seq_aln_dir', '-sad', type=str, default='data/msa/seq_aln_a2m', 
                        help='Directory containing a2m files of multiple sequence alignments')
    parser.add_argument('--alpha', type=float, default=0.8, 
                        help='Alpha value for combining logits')
