...
from evolvepro.src.data import load_dms_data, load_experimental_embeddings, load_experimental_data, create_iteration_dataframes, load_config, DictToObject, get_aux_data, get_gp_inputs
from evolvepro.src.utils import pca_embeddings
from evolvepro.src.model import first_round
from gp.gaussion_process import top_layer
    ...
    for i in range(1, num_simulations + 1):
        ...
        while j <= num_iterations:
            ...
            if j == 0:
                ...
                median_activity_scaled, top_activity_scaled, top_variant, top_final_round_variants, activity_binary_percentage, spearman_corr, ndcg, topk_pr, df_test_new, this_round_variants = top_layer(
                    ...
                    measured_var=measured_var, top_n=top_n, final_round=final_round)
