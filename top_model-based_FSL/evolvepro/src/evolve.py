    ...
    for i in range(1, num_simulations + 1):
        ...
        while j <= num_iterations:
            ...
            if j == 0:
                ...
                train_error, test_error, train_r_squared, test_r_squared, alpha, median_activity_scaled, top_activity_scaled, top_variant, top_final_round_variants, activity_binary_percentage, spearman_corr, ndcg, topk_pr, df_test_new, this_round_variants = top_layer(
